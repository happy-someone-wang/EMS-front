<template>
    <div>
        ...
        <el-card v-for="(course,index) in courseList" :key="course.courseId" 
            class="course-card" shadow="hover" >
            <el-row :gutter="20" class="course-list-header">
                ...
                <el-col :span="3">学分</el-col>
                <el-col :span="3">我的角色</el-col>
            ...
            <el-row :gutter="20">
                ...
                <el-col :span="3">{{ course.credit }}</el-col>
                <el-col :span="3">{{ course.level==0?'责任教师':'任课教师' }}</el-col>
                <el-col :span="2"><el-button type="text" @click.prevent="gotoCourseHome(course.courseId)">进入</el-button></el-col>
            </el-row>
        </el-card>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        gotoCourseHome(courseId) {
            this.$router.push({ path: `/teacher/course/${courseId}`})
