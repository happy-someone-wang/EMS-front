<template>
  <div>
    <el-row>
      <div style="font-size: 24px; color: cornflowerblue;display: flex;justify-content: center;align-items: center;">
        管理员页面</div>
    </el-row>
    <el-card class="card-item">
      <div class="condition-title">用户列表</div>
      <el-table ref="singleTable" :data="userTable" highlight-current-row style="width: 100%" v-loading="loading">
    ...
    <el-card class="card-item">
      ...
      <el-table ref="singleTable" :data="noticeList" highlight-current-row style="width: 100%" v-loading="loading">
