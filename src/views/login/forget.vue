<template>
  <div class="login-container">
    ...
    >
      ...
      <el-form-item prop="userId" class="input-box">
      ...
      <el-form-item prop="emailConfirm" class="input-box">
        ...
        <el-input
          ref="emailConfirm"
          v-model="loginForm.emailConfirm"
          placeholder="验证码"
          name="emailConfirm"
          type="text"
          tabindex="2"
...
import { sendForgetEmail, resetPassword } from "@/api/student";
export default {
  name: "Login",
  data() {
    ...
    return {
      loginForm: {
        userId: 2051196,
        role: "student",
        password: "Lyf123456789",
        confirmPassword: "Lyf123456789",
      },
      loginRules: {
        email: [
          {
        ...
        emailConfirm: [
          { required: true, trigger: "blur", validator: validateemailConfirm },
        ],
        password: [
  ...
  methods: {
    sendEmail() {
      ...
      console.log(this.loginForm.userId, this.loginForm.role);
      sendForgetEmail(this.loginForm.userId, this.loginForm.role).then(
        (response) => {
          this.confirmCode = response.data;
    ...
    handleForget() {
      ...
      this.$refs.loginForm.validate((valid) => {
        if (valid) {
          resetPassword(this.loginForm.userId,this.loginForm.role,this.loginForm.password).then((response) => {
            console.log(response);
