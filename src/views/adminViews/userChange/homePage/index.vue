<template>
  <div>
      ...
      <div class="condition-body">
        <el-form :inline="true" class="condition-form" @submit.native.prevent>
          <el-form-item class="conditon-form-item1" label="学号/工号">
            ...
            <el-autocomplete class="inline-input" :trigger-on-focus="false" popper-class="el-autocomplete-suggestion"
              v-model="filterForm.index" placeholder="请输入ID" size="small"
              @keyup.enter.native="submit"></el-autocomplete>
          </el-form-item>

          <el-form-item style="margin-bottom: 0px; margin-left: 150px" label="用户类型">
    ...
    <el-card class="card-item">
      ...
      <el-table ref="singleTable" :data="result" highlight-current-row style="width: 100%" v-loading="loading">
...
export default {
  ...
  methods: {
    handleClick(row) {
      ...
      this.$router.push({
        name: "Change",
        query: { id: row.index, type: row.type },
      });
    },
  },
};
